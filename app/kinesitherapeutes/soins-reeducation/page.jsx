    ...
    <main className="kine-page">
      <section className="kine-info-panel">
        <nav className="kine-anchor-nav" aria-label="Accès rapide sections">
          <a className="kine-anchor-link" href="#kine-reeducation-generale">
            Rééducation générale
          </a>
          <a className="kine-anchor-link" href="#kine-prescrimouv">
            Cabinet labellisé Prescri’Mouv
          </a>
          <a className="kine-anchor-link" href="#kine-specialites">
        ...
        <div id="kine-reeducation-generale" className="kine-info-block">
          ...
          <p>
            La rééducation générale regroupe l’ensemble des actes relevant du décret
            de compétences des masseurs-kinésithérapeutes, incluant l’évaluation, la
            prévention, le traitement et la réadaptation des déficiences et
          ...
          <p>
            Chaque prise en charge est personnalisée en fonction de votre douleur, de
            votre mobilité et de vos objectifs.
          </p>
        </div>
        ...
        <div id="kine-prescrimouv" className="kine-info-block">
          ...
          <p>
            Notre cabinet est labellisé Prescri’Mouv, un dispositif régional reconnu
            qui accompagne les personnes souffrant de douleurs chroniques ou de
            pathologies limitant l’activité physique. Ce programme permet aux médecins
            généralistes et spécialistes d’orienter leurs patients vers une activité
            physique adaptée et sécurisée, encadrée par des professionnels formés au
            sport-santé, dont les masseurs-kinésithérapeutes.
          </p>
          ...
          <p>
            • un suivi permettant de retrouver confiance dans le mouvement et de réduire
            les douleurs chroniques.
          </p>

          <p>Le dispositif Prescri’Mouv s’adresse notamment :</p>
          <p>
            • aux personnes présentant des douleurs chroniques (lombalgies,
            cervicalgies, troubles musculo-squelettiques…) ;
          </p>
          <p>
            • aux patients atteints d’affection longue durée, diabète obésité,
            cancers, maladies respiratoires, maladies cardio vasculaires…
          </p>
          <p>
            • à toute personne souhaitant reprendre une activité physique de manière
            sécurisée et encadrée.
          </p>
          ...
          <p>
            Notre équipe vous accompagne pour retrouver un mouvement confortable,
            durable et adapté à votre quotidien.
          </p>
        </div>
